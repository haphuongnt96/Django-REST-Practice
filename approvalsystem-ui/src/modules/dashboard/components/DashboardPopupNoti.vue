...
import DashboardPopupNotiTable from '@/modules/dashboard/components/DashboardPopupNotiTable.vue'
@Component({
  components: {
    DashboardPopupNotiTable
  }
})
export default class DashboardPopupNoti extends Vue {
  //*===🍎===🍎===🍎===🍎===🍎===🍎===🍎===🍎===🍎===🍎===🍎===🍎Data
  //#region COMPUTED
  name = ''
  valid = true
      ...
      <v-card-text>
        <div class="search__form">
          ...
          <div class="search__form-result">
            <DashboardPopupNotiTable @applicationCotent="applicationCotent" />
          </div>
        </div>
      </v-card-text>
    </v-card>
